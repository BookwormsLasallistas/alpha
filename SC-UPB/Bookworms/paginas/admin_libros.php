...
if (isset($_POST['enviar'])){
    ...
    $qry ="INSERT INTO libros (nombre, autor, publicacion, sinopsis, portada, disponibilidad, lenguaje, genero, editorial) VALUES ('$nombre', '$autor', '$publicacion', '$sinopsis', '$carpetaDestino', '$disponibilidad', '$lenguaje', '$genero', '$editorial')";   
...
<div class="container-form">
    ...
    <h1 class="text-admin">Ingreso de libros</h1>
    <fieldset>
    <label>Nombre:</label>
    ...
    <select name="lenguaje" class="form-control">
        <option disabled selected>Escoge el lenguaje del libro</option>
    ...
    <select name="genero[]" class="form-control" multiple>
        <option disabled selected>Escoge el género del libro</option>
    ...
    <select name="editorial" class="form-control">
        <option disabled selected>Escoge la editorial del libro</option>
...
<center><div class="p-5 mb-4 bg-outline-light rounded-3 col-md-9">
            <h1 class="text-admin"><center>Lista de Libros</center></h1>
            <div class="table-responsive">
            <div class="container-fluid">
            </div>
                <?php
                    $qry="SELECT * FROM libros";
                    $resultado=mysqli_query($conn,$qry);
                ?>
                <table class="table table-light table_id data-dynamic-table-wrapper table-responsive display"  tabindex="0" id="Tabla-libros">
                    <thead>
