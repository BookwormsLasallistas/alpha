...
if (isset($_GET['id'])){
    $id = $_GET['id'];
    $qry="SELECT * FROM libros WHERE id ='$id'";
...
if (isset($_POST['enviar'])){
    ...
    $qry2 = "UPDATE libros SET nombre='$nombre', autor='$autor', publicacion='$publicacion', sinopsis='$sinopsis', portada='$carpetaDestino', disponibilidad='$disponibilidad', lenguaje='$lenguaje', genero='$genero', editorial='$editorial' WHERE id='$id'";
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <label for="image">Selecciona una imagen:</label>
            ...
            window.onload = redirect;
                window.location = '../paginas/admin_libros.php';
            </script>";
            }
            ?>
    </form>
