...
if (isset($_GET['id_prestamo_revista'])){
    $id = $_GET['id_prestamo_revista'];
    $qry="SELECT * FROM prestamos_revistas WHERE id_prestamo ='$id'";
...
if (isset($_POST['enviar'])){
    ...
    $qry2 = "UPDATE prestamos_revistas SET fecha_prestamo='$fechaHoy', fecha_devolucion='$fechaD' WHERE id_prestamo='$id'";
